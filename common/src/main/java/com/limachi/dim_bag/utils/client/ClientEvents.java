package com.limachi.dim_bag.utils.client;
...
/**
 * all the architectury client events as Class references to be used with {@link com.limachi.dim_bag.utils.client.annotations.RegisterClientEventListener}
 */
