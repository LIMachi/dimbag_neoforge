...
class HolderData implements VibrationSystem {
    ...
    protected final DynamicGameEventListener<Listener> dynamicGameEventListener;
    protected final DynamicVibrationUser vibrationUser;
    protected Data vibrationData;
    ...
    protected static class DynamicVibrationUser implements User {
        ...
        protected Direction extractDirection(BlockPos pos) {
        ...
        @Override
        public void onReceiveVibration(ServerLevel level, BlockPos pos, Holder<GameEvent> event, @Nullable Entity entity, @Nullable Entity indirect, float fdistance) {
    ...
    public void tick(BagInstance instance, Entity entity) {
        if (entity != null && entity.level() instanceof ServerLevel serverlevel) {
            ...
            Ticker.tick(serverlevel, vibrationData, vibrationUser);
        }
    }
